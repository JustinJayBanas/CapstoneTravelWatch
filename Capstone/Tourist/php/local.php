...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkEmailQuery = "SELECT * FROM local_tourist WHERE BINARY email='$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $checkUsernameQuery = "SELECT * FROM local_tourist WHERE BINARY username='$username'";
        ...
        if (mysqli_num_rows($usernameResult) > 0) {
            ...
            $sql = "INSERT INTO local_tourist (username, age, gender, province, password, email) 
                    VALUES ('$username', '$age', '$gender', '$province', '$password', '$email')";
